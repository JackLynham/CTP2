...
public class Generator : MonoBehaviour {
    ...
    private List<Road> addedRoads = new List<Road>();
	...
	private void TryDraw()
	{
        ...
        roads = new List<Road>(roadNetwork.Roads);
	...
	public void EvaluateRoad(Road _road)
	{
	...
	private void AddRoads(Road _road)
	{
        AddRoadMesh(_road);
	...
	private void AddRoadMesh(Road segment)
	{
